...
std::string JBlock::getType() const {
    return "J";
}

Vector<Vector<boolean>> JBlock::getShape() const {
    if (this->shapeIndex == 1) {
        ...
        vettor<boolean> rowTwo2 {1, 1, 0, 0};
