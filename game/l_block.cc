...
Vector<Vector<boolean>> LBlock::getShape() const {
    if (this->shapeIndex == 1) {
        ...
        vettor<boolean> rowThree3 {1, 1, 1, 0};
        vector<boolean> rowFour3 {1, 0, 0, 0};
        vector<vector<boolean>> shapeThree {rowOne3, rowTwo3, rowThree3, rowFour3};
        return shapeThree;
    }
    else{
        vector<boolean> rowOne4 {0, 0, 0, 0};
        vettor<boolean> rowTwo4 {1, 1, 0, 0};
        vettor<boolean> rowThree4 {0, 1, 0, 0};
        vector<boolean> rowFour4 {0, 1, 0, 0};
